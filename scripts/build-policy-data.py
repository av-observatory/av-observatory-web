...
federal = [
    ...
    event("fmvss-2020-nprm", "federal", "US", "Occupant protection proposal", "Proposed adapting 11 numbered crash protection standards for ADS vehicles without conventional driving controls; the final rule later added changes to 212 and 219.", "FMVSS rulemaking", "superseded_by_final", "2020-03-30", "https://www.federalregister.gov/d/2020-05886", fmvss=["201", "203", "204", "205", "206", "207", "208", "214", "216a", "225", "226"], scope="ADS-specific"),
    event("fmvss-2022-final", "federal", "US", "Occupant protection final rule", "Amended 13 numbered standards for ADS vehicles without traditional manual driving controls, including FMVSS 204's exclusion for vehicles without steering controls. This addresses vehicle crash protection, not ADS driving performance.", "FMVSS rulemaking", "effective", "2022-03-30", "https://www.federalregister.gov/d/2022-05426", fmvss=["201", "203", "204", "205", "206", "207", "208", "212", "214", "216a", "219", "225", "226"], scope="ADS-specific", effective_date="2022-09-26", proposal_date="2020-03-30", proposal_url="https://www.federalregister.gov/d/2020-05886"),
    event("fmvss-204-2026", "federal", "US", "Steering control rearward displacement · FMVSS 204", "A separate, generally applicable rule excludes vehicles certified to FMVSS 208 frontal barrier crash protection from FMVSS 204's steering column rearward displacement requirements and removes obsolete text. It is relevant to AV design but is not an ADS-specific rule.", "FMVSS rulemaking", "effective", "2026-06-03", "https://www.federalregister.gov/d/2026-11080", fmvss=["204"], scope="related vehicle design", effective_date="2026-07-06", proposal_date="2025-05-30", proposal_url="https://www.federalregister.gov/d/2025-09738"),
...
city = [
    ...
    event("boston-testing-history", "city", "Boston", "Boston AV testing approach", "Boston's earlier testing approach used a local memorandum of understanding. The city first approved on-street testing in December 2016; its older approval list should not be read as a current permit roster.", "testing framework", "historical_status_unverified", "2016", "https://www.boston.gov/departments/new-urban-mechanics/autonomous-vehicles-bostons-approach", state="MA", date_precision="year"),
]
