...
const TILE_POSITIONS: Record<string,[number,number]> = {
  ME:[1,12], VT:[2,11], NH:[2,12],
  WA:[3,1], ID:[3,2], MT:[3,3], ND:[3,4], MN:[3,5], WI:[3,6], MI:[3,7], NY:[3,9], MA:[3,11],
  OR:[4,1], NV:[4,2], WY:[4,3], SD:[4,4], IA:[4,5], IL:[4,6], IN:[4,7], OH:[4,8], PA:[4,9], NJ:[4,10], CT:[4,11], RI:[4,12],
